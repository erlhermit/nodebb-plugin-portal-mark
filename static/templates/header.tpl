    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse navbar-ex1-collapse">
        ...
        <ul id="main-nav" class="nav navbar-nav pull-left">
          ...
          <li id="forum-menu" class="forum-menu dropdown">
            <a class="dropdown-toggle hidden-xs" data-toggle="dropdown" href="#" title="[[portalmark:title.forum]]" id="forum-dropdown">
              <i class="fa fa-fw fa-comments"></i> <span>[[portalmark:title.forum]]</span>
            </a>
            <button type="button" class="navbar-toggle" data-toggle="dropdown" data-target=".forum-menu">
            ...
            <ul id="forum-view-list" class="dropdown-menu" aria-labelledby="forum_dropdown">
              <li>
                <a href="{relative_path}/forum" title="[[portalmark:title.forum_index]]">
                  <i class="fa fa-fw fa-tree"></i><span> [[portalmark:title.forum_index]]</span>
                </a>
              </li>
              ...
              <li>
                <a href="{relative_path}/tags" title="[[global:header.tags]]">
                  <i class="fa fa-fw fa-tags"></i><span> [[global:header.tags]]</span>
                </a>
              </li>
              <li>
                <a href="{relative_path}/popular" title="[[global:header.popular]]">
                  <i class="fa fa-fw fa-fire"></i><span> [[global:header.popular]]</span>
                </a>
              </li>
              <li>
                <!-- IF function.displayUsersLink -->
                <a href="{relative_path}/users" title="[[global:header.users]]">
                  <i class="fa fa-fw fa-users"></i><span> [[global:header.users]]</span>
                </a>
