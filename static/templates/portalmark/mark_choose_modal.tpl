<div id="mark_choose_modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="Mark Topic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="data-list tags clearfix">
        </div>
        <div id="mark-confirm" style="display: none;">
          <hr />
          <div class="alert alert-info tags"> <strong><span id="confirm-marks-name" class="mark-list tag-list"></span></strong>
          </div>
        </div>
      </div>
