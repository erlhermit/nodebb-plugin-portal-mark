<div class="marks tags">
	...
	<!-- ENDIF !marks.length -->
							<div class="new-mark-modal hidden">
								<div class="form-group">
									<label for="markTag">Mark Tag* <span class="label label-warning">can not modify</span></label>
	...
	<div class="col-lg-3">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<input class="form-control" type="text" id="mark-search" placeholder="Search..."/><br/>
			</div>
		</div>
	</div>
